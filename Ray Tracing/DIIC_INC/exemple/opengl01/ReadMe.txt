========================================================================
    APPLICATION CONSOLE : vue d'ensemble du projet opengl01
========================================================================

AppWizard a créé cette application opengl01 pour vous.  
Ce fichier contient un résumé du contenu de chacun des fichiers qui
constituent votre application opengl01.
...
StdAfx.h, StdAfx.cpp
    ...
    nommé opengl01.pch et un fichier de type précompilé nommé StdAfx.obj.

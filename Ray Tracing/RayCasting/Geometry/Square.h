...
namespace Geometry
{
	/** \brief Classe représentant la géométrie d'un carré */
	...
	public:
		...
		Square(Material * material)
			: Geometry()
		{
			int p0 = addVertex(Math::Vector3(0.5, 0.5, 0.0)) ;
			int p1 = addVertex(Math::Vector3(0.5, -0.5, 0.0)) ;
			int p2 = addVertex(Math::Vector3(-0.5, 0.5, 0.0)) ;
			int p3 = addVertex(Math::Vector3(-0.5, -0.5, 0.0)) ;

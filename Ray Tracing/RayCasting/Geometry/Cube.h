...
namespace Geometry
{
	...
	public:
			...
			: Geometry()
		{
			...
			//m_square[1]->rotate(Math::Quaternion(Math::Vector3(1.0f,0.0f,0.0f), (float)M_PI/2.0f)) ;
			//m_square[2] = new Square(material) ;
			//m_square[2]->translate(Math::Vector3(0.0f,0.0f,0.5f)) ;
			//m_square[2]->rotate(Math::Quaternion(Math::Vector3(1.0f,0.0f,0.0f), (float)M_PI)) ;
			//m_square[3] = new Square(material) ;
			//m_square[3]->translate(Math::Vector3(0.0f,0.0f,0.5f)) ;
			//m_square[3]->rotate(Math::Quaternion(Math::Vector3(1.0f,0.0f,0.0f), (float)-M_PI/2.0f)) ;
			//m_square[4] = new Square(material) ;
			//m_square[4]->translate(Math::Vector3(0.0,0.0,0.5)) ;
			//m_square[4]->rotate(Math::Quaternion(Math::Vector3(0.0f,1.0f,0.0f), (float)M_PI/2.0f)) ;
			//m_square[5] = new Square(material) ;
			//m_square[5]->translate(Math::Vector3(0.0f,0.0f,0.5f)) ;
			//m_square[5]->rotate(Math::Quaternion(Math::Vector3(0.0f,1.0f,0.0f), (float)-M_PI/2.0f)) ;
